...
{{ session()->get('Message') }}
  ...
  <form method="post" action="{{  url('/doSignup') }}"  enctype ="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="tel" name="phone"   value="{{ old('phone') }}"   class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
  </div>
